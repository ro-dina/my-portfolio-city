...
export const codingProjects: Project[] = [
  {
    ...
    //  height: 630,
    //},
    links: [{ label: { ja: "GitHub", en: "GitHub" }, href: "https://example.com" }],
    body: {
      ja: () => (
        <>
          <Section title="概要">
      ...
      en: () => (
        <>
          <Section title="Overview">
            <p>
              Visualizes Bubble Sort, Merge Sort, Binary Search, and more using animated array bars.
              Built for learning with speed control, pause, step-by-step execution, and history rewind.
            </p>
          </Section>

          <ProductionBackground title="Background">
            <p>
              (Write your motivation and context here: why you built it, what problem it solves, and what you learned.)
            </p>
          </ProductionBackground>
  ...
  },
  {
    slug: "sort-simulator",
    title: { ja: "ソート・シミュレータ" },
    summary: { ja: "配列をドラッグで並べ替え → 正解との距離を採点。" },
    tags: ["React", "Tailwind CSS"],
    updatedAt: "2025-12-13",
    hero: {
      src: "/images/coding/sort-simulator.png",
      alt: { ja: "ソート・シミュレータのスクリーンショット" },
      width: 1200,
      height: 630,
    },
    body: { ja: () => (
  ...
  },
  {
    ...
    links: [{ label: { ja: "GitHub" }, href: "https://example.com" }],
    body: { ja: () => (
      <>
        <Section title="概要">
